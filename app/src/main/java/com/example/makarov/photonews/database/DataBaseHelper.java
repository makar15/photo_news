...
public class DataBaseHelper extends SQLiteOpenHelper implements BaseColumns {
    ...
    public static final String NAME_LOCATION_COLUMN = "name_location";
    ...
    public static final String URL_ADDRESS_COLUMN = "url_address";
    public static final String COUNT_LIKES_COLUMN = "count_likes";
    ...
    private static final String DATABASE_CREATE_SCRIPT_PHOTO_NEWS = "create table "
            + TABLE_PHOTO_NEWS + " (" + BaseColumns._ID + " integer primary key autoincrement, "
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL(DATABASE_CREATE_SCRIPT_PHOTO_NEWS);
    }
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF IT EXISTS " + TABLE_PHOTO_NEWS);
        onCreate(db);
    }
}
